...
//        var target = 'IntegratedSecurity_' + environment;
//        grunt.config(['replace', target], {
//            options: {
//                patterns: [{
//                    json: grunt.file.readJSON('./appNugets/Espa.Angular.IntegratedSecurity/environments/' + environment + '.json')
//                }],
//            },
//            files: [{
//                flatten: true,
//                src: ['./appNugets/Espa.Angular.IntegratedSecurity/Constants/gruntReplaceSource.js'],
//                dest: './appNugets/Espa.Angular.IntegratedSecurity/Constants/appConfigConstants.js'
//            }]
//        });
...
//        var target = tfs + '_IntegratedSecurity'

//        var command = 'cd ' + config.project.absoluteProjectPath + '&' +
//                      '"C:\\Program Files (x86)\\Microsoft Visual Studio 12.0\\Common7\\IDE\\tf.exe" ' + tfs + ' ' +
//                      config.project.tfsWorkSpace + 'appnugets\\espa.angular.IntegratedSecurity\\constants\\appConfigConstants.js';
